...
bool people_msgs__msg__position_measurement__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("people_msgs.msg._position_measurement.PositionMeasurement", full_classname_dest, 57) == 0);
  }
  people_msgs__msg__PositionMeasurement * ros_message = _ros_message;
  {  // header
  ...
  {  // reliability
    ...
    ros_message->reliability = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // covariance
  ...
  {  // initialization
    ...
    ros_message->initialization = PyBytes_AS_STRING(field)[0];
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PositionMeasurement */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("people_msgs.msg._position_measurement");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionMeasurement");
  ...
  {  // initialization
    PyObject * field = NULL;
    field = PyBytes_FromStringAndSize((const char *)&ros_message->initialization, 1);
    if (!field) {
      return NULL;
    }
    {
