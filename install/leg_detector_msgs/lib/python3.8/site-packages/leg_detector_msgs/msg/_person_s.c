...
bool leg_detector_msgs__msg__person__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("leg_detector_msgs.msg._person.Person", full_classname_dest, 36) == 0);
  }
  leg_detector_msgs__msg__Person * ros_message = _ros_message;
  {  // pose
...
PyObject * leg_detector_msgs__msg__person__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("leg_detector_msgs.msg._person");
