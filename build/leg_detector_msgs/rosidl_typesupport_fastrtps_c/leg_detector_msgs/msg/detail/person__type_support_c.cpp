...
#include "leg_detector_msgs/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
using _Person__ros_msg_type = leg_detector_msgs__msg__Person;
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_leg_detector_msgs__msg__Person(
...
{
  return max_serialized_size_leg_detector_msgs__msg__Person(
    full_bounded, 0);
}
